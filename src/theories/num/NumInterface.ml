...
and integer_to_int_integer (t:E.integer) : NE.integer =
  ...
  let toset = set_to_int_set in
    ...
    | E.IntMod(x,y)     -> raise(NotAnIntExpression(E.integer_to_str t))
...
and atom_to_int_atom (a:E.atom) : NE.atom =
  ...
  let toset = set_to_int_set in
    ...
    | E.Hashmap _     -> raise(NotAnIntExpression(E.atom_to_str a))
...
and integer_to_expr_integer (t:NE.integer) : E.integer =
  ...
  match t with
    ...
    | NE.Mod(x,y)     -> raise(NotAnIntExpression(NE.integer_to_str t))
